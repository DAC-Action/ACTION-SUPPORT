...
Public Class Form193
    ...
    Private Sub ExportToExcel()
        ...
        mSQLS1.CommandText += "(case when station in ('0475') then count(sn) else 0 end ) as t5,(case when station in ('0590') then count(sn) else 0 end ) as t6,"
        mSQLS1.CommandText += "(case when station in ('0640') then count(sn) else 0 end ) as t7,(case when station in ('0647','0670') then count(sn) else 0 end ) as t8, 0 as t9,0 as t10,0 as t11,0 as t12,0 as t13,0 as t14,0 as t15,0 as t16,"
        ...
        mSQLS1.CommandText += TimeS1.ToString("yyyy/MM/dd HH:mm:ss") & "' and '" & TimeS2.ToString("yyyy/MM/dd HH:mm:ss") & "' and station in ('0330','0331','0380','0530','0490','0620','0627','0475','0590','0640','0670') "
        ...
        mSQLS1.CommandText += "(case when scrap_sn.updatedstation in ('0475') then count(scrap.sn) else 0 end) as t13,(case when scrap_sn.updatedstation in ('0590') then count(scrap.sn) else 0 end) as t14,"
        mSQLS1.CommandText += "(case when scrap_sn.updatedstation in ('0640') then count(scrap.sn) else 0 end) as t15,(case when scrap_sn.updatedstation in ('0670') then count(scrap.sn) else 0 end) as t16,0,0,0,0,0,0,0,0 "
        ...
        mSQLS1.CommandText += TimeS1.ToString("yyyy/MM/dd HH:mm:ss") & "' and '" & TimeS2.ToString("yyyy/MM/dd HH:mm:ss") & "' and scrap_sn.updatedstation in ('0330','0331','0380','0530','0490','0620','0627','0475','0590','0640','0670')  "
        ...
        mSQLS1.CommandText += "(case when failstation in ('0475') then count(sn) else 0 end) as t21,(case when failstation in ('0590') then count(sn) else 0 end) as t22,"
        mSQLS1.CommandText += "(case when failstation in ('0640') then count(sn) else 0 end) as t23,(case when failstation in ('0670') then count(sn) else 0 end) as t24 "
        ...
        mSQLS1.CommandText += TimeS1.ToString("yyyy/MM/dd HH:mm:ss") & "' and '" & TimeS2.ToString("yyyy/MM/dd HH:mm:ss") & "' and rework <> 'SCRP' and failstation in ('0330','0331','0380','0530','0490','0620','0627','0475','0590','0640','0670') "
